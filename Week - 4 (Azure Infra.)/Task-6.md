# Task-6 : Azure Application Gateway Setup

## Resources

- [YouTube Tutorial on Azure Application Gateway](https://www.youtube.com/watch?v=-SRk0hHa-S0)
...
1. **Steps**:
   ...
   8. Configure the health probes to monitor the backend targets.
   9. Review and create the application gateway.
...
- For a detailed step-by-step visual guide, refer to the [YouTube Tutorial on Azure Application Gateway](https://www.youtube.com/watch?v=-SRk0hHa-S0).
